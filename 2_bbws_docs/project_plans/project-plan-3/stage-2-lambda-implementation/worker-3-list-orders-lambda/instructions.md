# Worker 3-list-orders-lambda: list_orders Lambda Implementation

**Lambda Function**: list_orders
**Trigger/Endpoint**: GET /v1.0/tenants/{tenantId}/orders
**Purpose**: Query with pagination

---

## Instructions

Implement the `list_orders` Lambda function following the comprehensive specifications in the Stage 2 Plan.
...
Refer to Stage 2 Plan section for list_orders for:
...
1. Lambda handler: `src/handlers/list_orders.py`
