# Worker 8-customer-confirmation-lambda: CustomerOrderConfirmationSender Lambda Implementation

**Lambda Function**: CustomerOrderConfirmationSender
**Trigger/Endpoint**: SQS → SES
**Purpose**: Send customer confirmation

---

## Instructions

Implement the `CustomerOrderConfirmationSender` Lambda function following the comprehensive specifications in the Stage 2 Plan.
...
Refer to Stage 2 Plan section for CustomerOrderConfirmationSender for:
...
1. Lambda handler: `src/handlers/CustomerOrderConfirmationSender.py`
