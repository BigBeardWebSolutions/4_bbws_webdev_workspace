# yourfinancialflow Tenant Infrastructure
...
data "aws_security_group" "ecs_tasks" {
  id     = var.ecs_security_group_id != "" ? var.ecs_security_group_id : null
  vpc_id = var.ecs_security_group_id == "" ? data.aws_vpc.main.id : null
