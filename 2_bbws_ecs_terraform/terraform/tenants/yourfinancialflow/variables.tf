# yourfinancialflow Tenant Variables

variable "tenant_name" {
  description = "Tenant name"
  type        = string
  default     = "yourfinancialflow"
}
...
variable "vpc_id" {
  description = "VPC ID (optional, use when multiple VPCs match by tag)"
  type        = string
  default     = ""
}

variable "ecs_security_group_id" {
  description = "ECS Security Group ID (optional, use when multiple SGs match by tag)"
  type        = string
  default     = ""
}
