# metisunicorns Tenant Infrastructure

# Get VPC - use vpc_id variable if provided, otherwise lookup by tags
data "aws_vpc" "main" {
...
data "aws_security_group" "ecs_tasks" {
  id     = var.security_group_id != "" ? var.security_group_id : null
  vpc_id = var.security_group_id == "" ? data.aws_vpc.main.id : null
